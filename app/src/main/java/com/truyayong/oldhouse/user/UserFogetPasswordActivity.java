...
public class UserFogetPasswordActivity extends AppCompatActivity {
    ...
    private static final String TAG = "UserFogetPasswordActivity";

    /**
     * Keep track of the login task to ensure we can cancel it if requested.
     */
    private UserFogetPasswordActivity.UseForgetTask mAuthTask = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRePasswordView = (EditText) findViewById(R.id.re_forget_password);

        etVerifyCode = (EditText)findViewById(R.id.et_user_forget_verifycode);
        tvGetVerifyCode = (TextView)findViewById(R.id.tv_forget_get_verifycode);
        ...
        Button btnResetPassword = (Button) findViewById(R.id.btn_phone_forget);
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(mRePassword) || !UserUtil.isPasswordValid(mRePassword) || !mPassword.equals(mRePassword)) {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserFogetPasswordActivity.UseForgetTask(mPhone, mPassword, mVerifyCode);
     ...
     * the user.
     */
    public class UseForgetTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UseForgetTask(String phone, String password, String verifycode) {
            mTaskPhone = phone;
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                mPasswordView.setError(getString(R.string.error_reset_password));
